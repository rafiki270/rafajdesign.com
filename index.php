...
<head>
	...
	<title>Rafaj Design - Concrete furniture &amp; Garden design</title>
...
<body>
	...
	<div class="modal fade" id="callmeModal" tabindex="-1" aria-hidden="true" role="dialog" aria-labelledby="ModalCall" style="display: none;">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<h2 class="modal-title getmetelf" id="ModalCall">Get in touch</h2>
				</div>
				<div class="modal-body">
					<!-- Your phone number -->
					<div class="myphone">+44 797 257 4949</div>
					<!-- Contact hours -->
	...
	<header>
		...
		<div id="top" class="container">
				...
				<ul class="nav">
			      <li class="dropdown">
			        ...
			        <ul class="dropdown-menu">
						...
						<li><a data-scroll data-options='{ "easing": "easeOutQuint" }' href="#about" class="menu-item wall">About Us</a></li>
						...
						<li><a data-scroll data-options='{ "easing": "easeOutQuint" }' href="#contact" class="menu-item wall">Contact Us</a></li>
			        </ul>
			      </li>
			    </ul>
			</nav>
			...
			<div class="nav-extra hidden-xs">
				...
				<!-- Button 'Hire me' -->
				<a class="hireme button-mywall" data-scroll data-options='{ "easing": "easeOutQuint" }' href="#contact">Hire us now</a>
			</div>
			<!-- // Menu right -->
		</div>
		<!-- // Menu Navigation -->
	...
	<section id="about" class="cd-intro">
		<h1 class="cd-headline letters type">
			...
			<span class="cd-words-wrapper waiting">
				<b class="is-visible">I am your garden</b>
				<b>I want to look pretty</b>
				<b>I could do with a makeover</b>
			</span>
		</h1>
	</section>
	<!-- // About Me Intro -->
	...
	<!-- About Me Context -->
	<section id="about" class="full-section my-about">
		<!-- Top About me -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-5 btn-class hidden-sm hidden-xs">
					<a class="btn-dwnld" href="#">Download Portfolio</a>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="contact" class="full-section-three bg-contact">
		<div class="container">
			<!-- Title Contact me -->
			<h1 class="title-ct">Contact us.</h1>
			<p class="separator-ct"></p>
			<!-- Localization -->
			<div class="row">
				<div class="col-md-12 col-xs-12 txt-center">
					<p class="text-ct">info@rafajdesign.com</p>
				</div>
			</div>
		</div>
		<!-- Contact Form -- >
	...
	<footer class="full-footer">
		<div class="container padding-footer">
			<!-- Text Left -->
			<div class="row">
				<div class="col-sm-8 foo-left">Let us help you be more happy. <br> Katerina &amp; Ondrej Rafaj</div>
				<!-- Text Right -->
				<div class="col-sm-4 foo-right">Made with <span class="glyphicon glyphicon-heart" aria-hidden="true"></span> in London</div>
			</div>
		</div>
	</footer>
	<!-- // Footer -->
